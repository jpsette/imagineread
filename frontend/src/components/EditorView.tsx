                    ...
                    >
                        ...
                        {editor.balloons.map((bubble) => (
                            <VectorBubble
                                ...
                                zoom={editor.zoom}
                                onSelect={() => editor.setSelectedBubbleId(bubble.id)}
                                onUpdateBox={(b) => editor.updateBubble(bubble.id, { box_2d: b })}
                                onUpdateTail={(t) => editor.updateBubble(bubble.id, { tailTip: t })}
                                onUpdateText={(text) => editor.updateBubble(bubble.id, { text })}
                            />
                        ))}
                    </div>
                </div>
                                ...
                                <div className="space-y-5 border-t border-[#27272a] pt-5">
                                    ...
                                    <div className="border-t border-[#27272a] pt-5">
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) => editor.updateBubble(editor.selectedBubbleId!, { text: e.target.value })}
                                            rows={4}
